					...
					<form class="mb-0" name="searchForm" onkeyup="enterkey()" action="/exhibition/ExSearchTitle.do" method="post">
						<div class="d-flex align-items-center">
							<div class="d-flex flex-grow-1 align-items-center">
								...
								<input type="text" placeholder="Exhibition Search Here !" name = "exhibition_title" id="searchInputBox"
								class="form-control shadow-none border-0 flex-grow-1 form-control-lg" onkeyup="characterCheck()" onkeydown="characterCheck()" >
							</div>
						</div>
					</form>
					<!-- 전시회 검색 끝  -->
