			...
			<div
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide"
						style="background-image: url('${voRand.exhibition_image}'); background-size: width:100%;">
						<div
								...
								<div class="col-xl-10 mx-auto text-center">
									...
									<ul class="carousel-layers list-unstyled mb-0 pt-lg-9">
										<li data-carousel-layer="fade-start">
											<h2 class="display-1 mb-3">${voRand.exhibition_title}</h2>
										</li>
										...
										<li data-carousel-layer="fade-start"><a href="#"
											class="btn btn-white btn-lg btn-hover-text mb-2 me-2"> <span
												class="btn-hover-label label-default">More View</span> <span
