			...
			<div class="container pt-14 pb-9 pb-lg-11">
				<div class="row pt-lg-7 justify-content-center text-center">
					<div class="col-xl-8">
						...
						<h1 class="display-2 mb-3">${customer_id}님 , 예매가 완료되었습니다.</h1>
						<p class="mb-5 lead mx-auto">상세 예매내역을 확인하기 위해서는 아래 버튼을 눌러주세요.</p>
						<a href="/exhibition/ExhibitionTicketingSelect.do?id=${customer_id}" class="btn btn-outline-primary btn-lg">
							Sign In</a>
