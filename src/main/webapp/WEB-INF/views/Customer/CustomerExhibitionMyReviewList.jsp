	...
	<header class="z-index-fixed">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-white">
			<div class="container position-relative">
				...
				<div class="d-flex align-items-center navbar-no-collapse-items order-lg-last" style="width: 88px; justify-content: flex-end;">
							...
							<div class="dropdown-menu p-lg-3">
								...
								<div class="dropend">
									<a class="dropdown-item"
										href="CustomerTicket.do" aria-expanded="false">My Ticket</a>
								</div>
								<div class="dropend">
									<a class="dropdown-item"
										href="CustomerTicket.do" aria-expanded="false">My Review</a>
								</div>
						...
						<div
							...
							<div class="col-sm-7 py-sm-5 col-12 col-lg-5 offset-lg-1 px-3">
								...
								<div class="d-grid pb-4 pb-md-0">
									<a href="#" class="btn btn-primary" style="margin-bottom:10px;">후기보기</a>
									<!-- 차후 form 태그 변경예정  -->
									<a href="CustomerExhibitionReviewWriteTest.do" class="btn btn-dark">후기삭제</a>
								</div>
