                ...
                <div class="container py-9 py-lg-11 position-relative z-index-1">
                      ...
                      <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row">
                        ...
                        <div class="col-md-6 mb-4 development grid-item">
                            <a href="customer/CustomerLogin.do" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                        ...
                        <div class="col-md-6 mb-4 motion grid-item">
                            <a href="company/CompanyLogin.do" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
