			...
			<div class="container pt-14 pb-9 pb-lg-11">
				<div class="row pt-lg-7 justify-content-center text-center">
					<div class="col-xl-8">
						...
						<h1 class="display-2 mb-3">가입을 거절당했어요...</h1>
						<p class="mb-5 lead mx-auto">다시 가입하러 가볼까요?</p>
						<p class="mb-5 lead mx-auto">(자세한 내용은 02-000-0000에 문의해주세요.)</p>
						<a href="CompanySignUp.do" class="btn btn-outline-primary btn-lg">
							ReSign Up</a>
