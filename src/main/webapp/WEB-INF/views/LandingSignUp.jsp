            ...
            <section id="page-header" class="position-relative bg-dark text-white overflow-hidden">
                <div class="container pt-12 pb-9">
                    <div class="row pt-lg-7">
                        <div class="col-lg-7">
                            <h1 class="mb-0 display-3">일반회원 | 업체회원 (회원가입)</h1>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container py-9 py-lg-11 position-relative z-index-1">
                      ...
                      <div id="projects" data-isotope='{"layoutMode": "masonry"}' class="row">
                        ...
                        <div class="col-md-6 mb-4 development grid-item">
                            <a href="customer/Agreement.do" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
                        ...
                        <div class="col-md-6 mb-4 motion grid-item">
                            <a href="company/Agreement.do" class="text-white bg-dark position-relative d-block overflow-hidden card-hover-2">
